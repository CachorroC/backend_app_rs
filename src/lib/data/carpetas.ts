...
const Carpetas: CarpetaRaw[] = [
  ...
  },
  {
    ...
    demanda: {
      ...
      mandamientoPago        : '01/03/2018            2/03/2018',
      notificacion           : {
        '291': {
  ...
  },
  {
    ...
    demanda: {
      ...
      entregaGarantiasAbogado: '15/06/2018',
      departamento           : 'CUNDINAMARCA',
      municipio              : 'BOGOTA',
      tipoProceso            : 'SINGULAR',
      radicado               : '2018 - 00623',
